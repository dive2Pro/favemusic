...
const mapDispatchToProps = (dispatch: Function) => {
  ...
  return {
    toggleExpandF: bindActionCreators(actions.setToggledF.bind(E$, FOLLOWERSTYPE), dispatch)
    , fetchMoreF: bindActionCreators(actions.fetchFollowersF, dispatch)
    , setToggledF: bindActionCreators(actions.setToggledF.bind(E$, FOLLOWERSTYPE), dispatch)
    ,
  }
}
